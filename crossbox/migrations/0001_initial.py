# Generated by Django 3.0.8 on 2020-08-12 20:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_product_id', models.IntegerField(verbose_name='ID Producto Stripe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_customer_id', models.IntegerField(null=True, verbose_name='ID Cliente Stripe')),
                ('stripe_subscription_id', models.IntegerField(null=True, verbose_name='ID Subscripción Stripe')),
                ('fee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='subscribers', to='crossbox.Fee')),
