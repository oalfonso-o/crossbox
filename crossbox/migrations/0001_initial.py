# Generated by Django 3.0.8 on 2020-08-15 18:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_billing_cycle_anchor', models.IntegerField(blank=True, null=True, verbose_name='Timestamp próximo pago')),
                ('stripe_subscription_price_item_id', models.CharField(max_length=30, null=True, verbose_name='ID Precio de Subscripción Stripe')),
                ('last_payment_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Fecha último pago')),
